...
TRAIN_DATASET = "gs://bloodwise-dataset/llm-finetune-dataset-small/train.jsonl" # Replace with your dataset
VALIDATION_DATASET = "gs://bloodwise-dataset/llm-finetune-dataset-small/test.jsonl" # Replace with your dataset
...
def train(wait_for_job=False):
    ...
    sft_tuning_job = sft.train(
        ...
        tuned_model_display_name="medical-llm-v1",
    )
